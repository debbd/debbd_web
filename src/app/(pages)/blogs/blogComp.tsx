  ...
  return (
    <div className="mt-20  w-full h-[400px]">
      <div className="secondary-layout-width mx-auto w-full ">
        ...
        <div className="mt-5 grid grid-cols-3 gap-8 pb-20">
          {posts.length > 0 &&
            posts.map((post, i) => {
              return (
                <div className="w-full h-full flex flex-col " key={i}>
                  <div className="relative rounded-lg overflow-hidden">
                    ...
                    <div className="w-full h-[170px] relative z-[10]  flex justify-between items-end">
                      <div className=" w-full absolute flex justify-start items-center gap-2 p-3">
                  ...
                  <div className="w-full p-3 flex flex-col flex-1">
                    <div className="mt-1 flex justify-between items-center">
                      ...
                      <div className="shrink-0 flex justify-end items-center gap-2">
                        <p className="text-read-13 font-medium text-foreground-3">
                          Author{" "}
                        </p>
                        <Image
